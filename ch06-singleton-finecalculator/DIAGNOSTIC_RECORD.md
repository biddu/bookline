# Diagnostic record — Exhibit 6B (singleton FineCalculator)

Exhibit 6B in Chapter 6 §6.3 is an **author-constructed diagnostic artefact** in the
...
(it injected calendar, repository, Clock and rate via constructor, refused the wall clock in prose, and shipped the fixture-calendar closure test unasked). The mode remains real in inherited code, in smaller models, and in inline
